...
refreshList = () => {
	...
	.get("http://localhost:8000/api/mytasks/")
...
handleSubmit = (item) => {
	...
	axios
		.put(`http://localhost:8000/api/mytasks/${item.id}/`, item)
		.then((res) => this.refreshList());
	return;
	}
	// if new post to submit
	axios
	.post("http://localhost:8000/api/mytasks/", item)
	.then((res) => this.refreshList());
};
...
handleDelete = (item) => {
	...
	axios
	.delete(`http://localhost:8000/api/mytasks/${item.id}/`)
	.then((res) => this.refreshList());
};
